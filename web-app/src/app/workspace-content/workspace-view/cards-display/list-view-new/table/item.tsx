...
export function Row({ children, className, style }: RowProps) {
  ...
  return (
    <tr className={cn(styles.row, styles.fillRow, className)} style={style}>
    ...
    return (
      <React.Fragment>
        ...
        >
          ...
          {groupBy === 'workspace' ? null : <WorkspaceCell note={note} />}
...
const WorkspaceCell = ({
  ...
  return (
    ...
    >
      ...
      /> */}
      <WorkspaceIndicatorComponent note={note} groupBy={''} />
    </Cell>
  );
};
