...
export const COLUMN_VERSION_KEY = 'version';
...
function isLowPriorityRef(ref: RefInfo): boolean {
  return ref.namespace === NS_NOTES;
}

export function compareRefInfo(r1: RefInfo, r2: RefInfo): number {
  const lowP1 = isLowPriorityRef(r1);
  const lowP2 = isLowPriorityRef(r2);
