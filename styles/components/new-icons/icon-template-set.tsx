...
export enum TemplateSetState {
  Default = 'default',
  Primary = 'primary',
}

const COLOR_MAP = {
  [TemplateSetState.Default]: {
    var1: theme.mono.m10,
    var2: theme.mono.m6,
    var3: theme.mono.m4,
  },
  [TemplateSetState.Primary]: {
...
export interface IconTemplateSetProps extends IconProps {
  state?: TemplateSetState;
}

export function IconTemplateSet({
  size = IconSize.Small,
  className,
  state = TemplateSetState.Primary,
  style = {},
}: IconTemplateSetProps) {
